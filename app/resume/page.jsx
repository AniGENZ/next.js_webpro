...
const about = {
    title: "About me",
    description:"GOJO yeeeeeeeeeeee",
    info:[
        {
            fieldName: "Name",
            fieldValue: "Anirudh"
        ...
        {
            fieldName: "strength",
            fieldValue: "undefined...too powerful mwhehehe"
        },
        {
            fieldName: "Hero Name",
            fieldValue: "ZUZU!"
        },
        {
            ...
            fieldValue: "from pinato planet...thats my planet hehe"
        },
        {
            fieldName: "Speciality",
            fieldValue: "Everything NYAHAHAHA...i can do anything ;p"
        },
        {
            fieldName: "Language",
            fieldValue: "i speak c++,python..etc... cuz WHY NOT! ;p"
        },
    ]
...
const experience = {
    title: "My experience",
    description: "i have just started"
};

const education = {
    title: "My Education",
    description: "below hehe...",
    items: [
        {
                                        ...
                                        return (
                                            <li key={index} className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    <span className="w-[6px] h-[6px] rounded-fullk bg-purple-500"></span>
